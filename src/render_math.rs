...
impl Vector2
{
    ...
    {
        Vector2 {
            elements: [self.elements[0] + other.elements[0]m self.elements[1] + other.elements[1]],
        }
    }
}
...
impl Vector3
{
    ...
    {
        Vector3 {
            elements: [self.elements[0] + other.elements[0]m self.elements[1] + other.elements[1], self.elements[2] + other.elements[2]],
        }
    }
}
...
impl Vector4
{
    ...
    {
        Vector4 {
            elements: [self.elements[0] + other.elements[0]m self.elements[1] + other.elements[1], self.elements[2] + other.elements[2], self.elements[3] + other.elements[3]],
        }
    }
}
